export const KA_LOCS = [
  { n:"Sakleshpur",     d:"Hassan",         pin:"573134", lat:12.9417, lng:75.7850 },
  { n:"Channapatna",    d:"Ramanagara",     pin:"562160", lat:12.6518, lng:77.2067 },
  { n:"Doddaballapur",  d:"Bengaluru Rural",pin:"561203", lat:13.2945, lng:77.5378 },
  { n:"Hoskote",        d:"Bengaluru Rural",pin:"562114", lat:13.0707, lng:77.7981 },
  { n:"Kolar",          d:"Kolar",          pin:"563101", lat:13.1377, lng:78.1299 },
  { n:"Tumkur",         d:"Tumakuru",       pin:"572101", lat:13.3409, lng:77.1010 },
  { n:"Hassan",         d:"Hassan",         pin:"573201", lat:13.0033, lng:76.1004 },
  { n:"Mysuru",         d:"Mysuru",         pin:"570001", lat:12.2958, lng:76.6394 },
  { n:"Mandya",         d:"Mandya",         pin:"571401", lat:12.5239, lng:76.8951 },
  { n:"Shivamogga",     d:"Shivamogga",     pin:"577201", lat:13.9299, lng:75.5681 },
  { n:"Davangere",      d:"Davangere",      pin:"577001", lat:14.4663, lng:75.9238 },
  { n:"Hubli",          d:"Dharwad",        pin:"580020", lat:15.3647, lng:75.1240 },
  { n:"Raichur",        d:"Raichur",        pin:"584101", lat:16.2076, lng:77.3463 },
  { n:"Bidar",          d:"Bidar",          pin:"585401", lat:17.9133, lng:77.5301 },
  { n:"Chikkamagaluru", d:"Chikkamagaluru", pin:"577101", lat:13.3161, lng:75.7720 },
  { n:"Ramanagara",     d:"Ramanagara",     pin:"562159", lat:12.7219, lng:77.2816 },
  { n:"Sira",           d:"Tumakuru",       pin:"572137", lat:13.7411, lng:76.9042 },
  { n:"Tiptur",         d:"Tumakuru",       pin:"572201", lat:13.2586, lng:76.4787 },
];
...
export const DEMO_USERS = [
  {
    id: "demo_farmer",
    name: "Ramesh Gowda",
    email: "farmer.demo@raithareach.app",
    password: "demo123",
    role: "farmer",
    district: "Hassan",
    village: "Sakleshpur",
  ...
  },
  {
    id: "demo_delivery",
    name: "Anil Delivery",
    email: "delivery.demo@raithareach.app",
    password: "demo123",
    role: "delivery",
    district: "Mandya",
    village: "Mandya",
...
// No seed crops — farmers post their own
export const SEED_CROPS = [];

// No seed jobs — created only when a bid is accepted
export const SEED_JOBS = [];

export const AGR_NEWS = [
  {id:1,cat:"Market", col:"#2d7a3a",title:"Tomato prices rise 18% across Karnataka APMC mandis this week",    meta:"Hassan Mandi · Today"},
  {id:2,cat:"Weather",col:"#1967d2",title:"IMD forecasts moderate rain in Western Ghats — plan harvest now",    meta:"Karnataka · Today"},
  {id:3,cat:"Policy", col:"#e8920a",title:"Karnataka announces 10% bonus on onion MSP for Rabi season",        meta:"NABARD · 2 days ago"},
  {id:4,cat:"Market", col:"#2d7a3a",title:"Sugarcane SAP rate raised to ₹3,400/tonne for 2025-26 season",      meta:"Sugar Board · 3 days ago"},
  {id:5,cat:"Scheme", col:"#7b1fa2",title:"PM-KISAN 19th instalment: ₹2000 to be credited by March 31",        meta:"Central Govt · Today"},
];

export const HELPLINES = [
  {name:"Kisan Call Centre", phone:"1800-180-1551",desc:"Free 24/7 agri helpline"},
  {name:"Karnataka APMC",    phone:"080-2334-7000", desc:"Mandi rates & queries"},
  {name:"NABARD",            phone:"022-2653-0000", desc:"Farm loans & credit"},
  {name:"PM-KISAN",          phone:"155261",        desc:"Farmer income support"},
];
...
export const NEXT_S  = {confirmed:"on-the-way","on-the-way":"picked-up","picked-up":"delivered"};
